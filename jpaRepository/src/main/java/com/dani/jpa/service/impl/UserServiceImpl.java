...
import static com.dani.jpa.data.specification.UserSpecifications.withAnyLanguage;
...
public class UserServiceImpl implements IUserService {
    ...
    public User createUser(final String name, final String surname, final Date birthDate, final String gender, final List<String> languages) {
        User user = new User();
        user.setName(name);
    ...
    public Page<User> getPaginatedUsersKnowingAnyLanguage(final int page, final int size, List<String> languages) {
        ...
        return userRepository.findAll(withAnyLanguage(languageService.findByNames(languages)), pageable);
    }
}
