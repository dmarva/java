...
public class UserSpecifications {
    ...
    public static Specification<User> withAnyLanguage(final List<Language> languages) {

        return new Specification<User>() {

            @Override
            public Predicate toPredicate(Root<User> root, CriteriaQuery<?> arg1, CriteriaBuilder criteriaBuilder) {
                return criteriaBuilder.any(root.get(User_.languages), languages);
            }
        };
    }
    ...
    public static Specification<User> withEveryLanguage(final List<Language> languages) {
        ...
        return new Specification<User>() {
            ...
            @Override
            public Predicate toPredicate(Root<User> root, CriteriaQuery<?> arg1, CriteriaBuilder criteriaBuilder) {
                return criteriaBuilder.equal(root.get(User_.languages), languages);
            }
        };
    }
